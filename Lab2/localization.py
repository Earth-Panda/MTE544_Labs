...
class localization(Node):
    ...
    def __init__(self, localizationType=rawSensor):
        ...
        #for sim, dur=2, for real, dur=check ros2 topic info /odom --verbose
    ...
    def odom_callback(self, pose_msg):
        ...
        odom_quaternion = pose_msg.pose.pose.orientation
        ...
        self.pose=[odom_x_pos, odom_y_pos, yaw, timestamp]
